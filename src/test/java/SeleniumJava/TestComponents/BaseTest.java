...
public class BaseTest {
	...
	public WebDriver InitializeDriver() throws IOException {
		...
		FileInputStream fis = new FileInputStream(System.getProperty("user.dir")+ "//src//test//java//SeleniumJava//resources//GlobalData.properties");
		prop.load(fis);
		...
		options.addArguments("headless");
		 ...
		 driver.manage().window().setSize(new Dimension(1440,900));
			...
			System.setProperty("webdiver.gecko.driver", "C:\\Users\\Ramana\\Downloads\\geckodriver");
